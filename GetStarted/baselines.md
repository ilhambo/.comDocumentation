...
###Steps
The process of creating a Baseline project is rather involved. While you don't have to worry about all of this (that's what Umbraco as a Service is for), it can be helpful to understand the parts that make up a baseline master-child relationship:
